 ...
 * @author Chris
 */
public class ControlaComputadora extends BoardController {
    ...
    public ControlaComputadora(SelectionGrid playerGrid, boolean preferMovesFormingLine, boolean maximiseAdjacentRandomisation) {
        super(playerGrid);
